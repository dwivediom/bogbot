...
def start():
    ...
    # while loop:
        ...
        driver = webdriver.Chrome(executable_path="D:\\projects\\blog bot\\botbysource\\tweiter\\chromedriver.exe")
        ...
        while i<6 :
         ...
         time.sleep(4)  
         link = driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/main/div/div/div/div/div/section/div/div/div[1]/div/div/div/article/div/div/div/div[3]/div[2]/div/div/a")
